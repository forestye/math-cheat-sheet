...
% --- 颜色定义 ---
\definecolor{headerblue}{RGB}{142, 68, 173} % 紫色主题
\definecolor{navcolor}{RGB}{211, 84, 0}
...
% --- 页眉 ---
\begin{center}
    {\Huge \textbf{\sffamily \textcolor{headerblue}{复变函数 Complex Analysis Cheat Sheet}}} \\
    \vspace{0.2cm}
...
\begin{mybox}[1. 基础 (Foundations)]{headerblue}
    \boxdesc{把“震荡”变为“旋转”}
...
\begin{mybox}[2. 全纯与解析 (Analyticity)]{headerblue}
...
\begin{mybox}[3. 积分与留数 (Integration)]{headerblue}
...
\begin{mybox}[4. 变换与映射 (Transforms)]{headerblue}
...
\begin{mybox}[5. 工程应用 (Engineering)]{headerblue}
    \boxdesc{从数学理论到物理实战}
...
\begin{mybox}[6. 算法与代码 (Code)]{headerblue}
